                ...
                <div className="mt-8 md:flex gap-6">
                    {!fileDisplay ? (
                        ...
                        >
                            ...
                            <label htmlFor="fileInput" className="px-2 py-1.5 mt-8 text-white 
                                text-[15px] w-[80%] bg-[#f02c56] rounded-md cursor-pointer"
                            >
                                Select file
                            </label>
                        ...
                        >
                            {isUploading ? (
                                <div className="absolute flex items-center justify-center z-20 
                                    bg-black h-full w-full rounded-[50px] bg-opacity-50"
                                >
                            ...
                            <img src="/images/tiktok-logo-white.png" width={90} 
                                className="absolute right-4 bottom-6 z-20" 
                            />

                            <video src={fileDisplay} autoPlay loop muted 
                            ...
                            <div className="absolute -bottom-12 flex items-center justify-between 
                                z-50 rounded-xl border w-full p-2 border-gray-300"
                            >
                                <div className="flex items-center truncate">
                                    <AiOutlineCheckCircle size="16" className="min-w-[16px]" />
                                    <p className="text-[11px] font-medium pl-1 truncate text-ellipsis">
                                        {file ? file.name : ''}
                                    </p>
                                </div>
                    ...
                    <div className="mt-4 mb-6">
                        <div className="flex bg-[#f8f8f8] py-4 px-6">
                            <div><PiKnifeLight className="mr-4" size="20" /></div>
                            ...
                            <div>
                                ...
                                <div className="font-semibold text-[13px] text-gray-400">
                                    ...
                                    redunant parts and turn landscape videos into portrait videos
                                </div>
                            </div>
                        ...
                        <div className="mt-5">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="text-gray-400 text-[15px]">{caption.length}/150</div>
                            </div>
                            <input type="text" maxLength={150} value={caption} 
                        ...
                        <div className="flex gap-3">
                            ...
                            <button disabled={isUploading} onClick={() => createNewPost()}
