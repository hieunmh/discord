...
export default function EditProfile() {
    ...
    return (
        <div id="EditProfile" className="fixed flex justify-center pt-14 md:pt-[105px] 
        ...
        >
            ...
            >
                <div className="absolute flex items-center justify-between w-full p-5 left-0 top-0 border-b border-b-gray-300">
                    ...
                    <button disabled={isUpdating} className="hover:bg-gray-200 p-1 rounded-full">
                ...
                <div className={`h-[calc(500px-200px)] ${!uploadedImage ? 'mt-16' : 'mt-[58px]'}`}>
                    {!uploadedImage ? (
                        <div>
                            ...
                            >
                                <h3 className="font-semibold text-[15px] sm:mb-0 mb-1 
                                ...
                                <div className="flex items-center justify-center sm:-mt-6">
                                    <label htmlFor="image" className="relative cursor-pointer">
                                        ...
                                        <button className="absolute bottom-0 right-0 rounded-full bg-white shadow-xl 
                                            border p-1 border-gray-300 inline-block w-[32px] h-[32px]"
                                        >
                            ...
                            <div id="UserNameSection" className="flex flex-col border-b sm:h-[118px] px-1.5 py-2 mt-1.5 w-full">
                                <h3 className="font-semmibold text-[15px] sm:mb-0 mb-1 
                                    text-gray-700 sm:w-[160px] sm:text-left text-center"
                                >
                                    Name
                                </h3>
                                ...
                                <div className="flex items-center justify-center sm:-mt-6">
                                    <div className="sm:w-[60%] w-full max-w-md">
                                        <TextInput string={userName}
                                            placeholder="Username" onUpdate={setUserName}
                                            inputType="text" error={showError('userName')}
                                        />
                            ...
                            <div id="UserBioSection" className="flex flex-col sm:h-[120px] px-1.5 py-2 mt-2 w-full">
                                ...
                                <div className="flex items-center justify-center sm:-mt-6">
                                    <div className="sm:w-[60%] w-full max-w-md">
                                        <textarea className="resize-none w-full bg-[#f1f1f2] text-gray-800
                                            border border-gray-300 rounded-md py-2.5 px-3 focus:outline-none"
                                            cols={30} rows={4} value={userBio || ''} maxLength={80}
                        ...
                        <div className="w-full max-h-[420px] mx-auto bg-black circle-stencil">
                            <Cropper stencilProps={{ aspectRatio: 1 }} className="h-[400px]"
                ...
                <div id="ButtonSection" className="absolute p-5 left-0 bottom-0 border-t border-t-gray-300 w-full">
                    {!uploadedImage ? (
                        <div id="UploadInfoBtn" className="flex items-center justify-end">
                            ...
                            >
                                <span className="px-2 font-medium text-[15px]">
                                    {isUpdating ? <BiLoaderCircle color="#ffffff" className="my-1 mx-2.5 animate-spin" />
                                        : "Save"
                                    }
                                </span>
                            </button>
                        ...
                        <div id="CropperBtn" className="flex items-center justify-end">
                            ...
                            <button onClick={() => cropAndUpdateImage()}
                                className="flex items-center bg-[#f02c56] text-white border rounded-md ml-3 px-3 py-[6px]"
                            >
                                <span className="px-2 font-medium text-[15px]">
                                    {isUpdating ? <BiLoaderCircle color="#ffffff" className="my-1 mx-2.5 animate-spin" />
