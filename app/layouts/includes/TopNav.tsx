        ...
        <div id="TopNav" className="fixed bg-white z-30 flex items-center w-full border-b h-[60px]">
            ...
            >
                ...
                <div className="relative hidden md:flex items-center justify-end 
                    bg-[#f1f1f2] p-1 rounded-full max-w-[430px] w-full"
                >
                    ...
                    <div className="absolute bg-white max-w-[910px] h-auto w-full z-20 left-0 top-12 border p-1">
                        <div className="p-1">
                            <Link href={`/profile/1`}
                                ...
                                hover:bg-[#f12b56] p-1 px-2 hover:text-white"
                            >
                                <div className="flex items-center">
                                    <img className="rounded-md" width={40} src="https://placehold.co/40" />
                                    <div className="truncate ml-2">Nguyen Minh Hieu</div>
                                </div>
                            </Link>
                        </div>
                    </div>
                ...
                <div className="flex items-center gap-3">
                    <button onClick={() => goTo()}
                        className="flex items-center border rounded-sm py-[6px] hover:bg-gray-200 pl-1.5"
                    >
                    ...
                    {true ? (
                        ...
                        <div className="flex items-center">
                            <div className="relative">
                                ...
                                <div className="absolute bg-white rounded-lg py-1.5 
                                    w-[200px] shadow-xl border top-[40px] right-0"
                                >
                                    <button className="flex items-center w-full justify-start 
                                        py-3 px-2 hover:bg-gray-200 cursor-pointer"
                                    >
                                        <BiUser size="20" />
