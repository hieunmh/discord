...
export default function SideNavMain() {
    ...
    return (
        <div id="SideNavMain" className={`fixed z-20 bg-white pt-[70px] h-full lg:border-r-0 border-r 
            w-[75px] overflow-auto ${pathname === '/' ? 'lg:w-[310px]' : 'lg:w-[220px]'}`}
        >
            <div className="lg:w-full w-[55px] mx-auto">
                <Link href="/">
                    <MenuItem iconString="For you" sizeString="25"
                    ...
                    <ClientOnly>
                        <div className="cursor-pointer">
                            <MenuItemFollow user={{id: "1", name: "hieu", image: "https://placehold.co/50"}} />
                        </div>
                    </ClientOnly>
