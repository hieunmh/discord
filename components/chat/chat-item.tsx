...
export const ChatItem = ({ id, content, member, timestamp, fileUrl, 
  deleted, currentMember, isUpdated, socketUrl, socketQuery
} : ChatItemProps) => {
        ...
        <div className="flex flex-col w-full">
          ...
          {!fileUrl && isEditing && (
            <Form {...form}>
                  ...
                  <FormItem className="flex-1">
                    <FormControl>
                      <div className=" relative w-full">
                        <Input className="p-2 bg-zinc-200/90 dark:bg-zinc-700/75 
              ...
              <span className="text-xs mt-1 text-zinc-400">Press escape to cancel, enter to save</span>
            </Form>
          )}
        </div>
      </div>
